            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="https://www.logoai.com/oss/icons/2021/10/27/l1eXTxm2w7TM6t9.png" alt="bird">
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <span class="front-para">Hey There....!!!</span>
                        <span class="join">Join ChirpChatter today.</span>
