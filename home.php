...
<head>
    ...
    <title>Home | ChirpChatter</title>
    
    <link rel="shortcut icon" type="image/png" href="assets/images/chirpchatter.png"> 
  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is ChirpChatter made by <span style="font-weight: 700;">Samarth, Roshan& Jay </span>  for learning purpose.</p>
        <p>It includes chirp , rechirp , qoute or even qoute the qouted chirp , like chirp and nested comments.
          you can mention or add hashtag to your chirp , change password or username.
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="https://www.logoai.com/oss/icons/2021/10/27/l1eXTxm2w7TM6t9.png" alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <div class="grid-sidebar bg-active" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="https://icon-library.com/images/home-icon-png-transparent/home-icon-png-transparent-25.jpg" alt="" height="26.25px" width="26.25px" />
            </div>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="https://www.pngall.com/wp-content/uploads/4/Settings-PNG0.png" alt="" height="26.25px" width="26.25px" />
            </div>
      ...
      <div class="grid-posts">
                        ...
                        <div class="bottom"> 
                         ...
                         <?php } } unset($_SESSION['errors_tweet']); ?>
                          <div>
                            ...
                            <input id="tweet-input" type="submit" name="tweet" value="chirp" class="submit"
                            >
                          </div>
                      </div>
                      </form>
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search ChirpChatter">
